  ...
  <div class="page-container">
    ...
    <div class="table-card">
      <div class="table-header">
        <div class="section-title"><i></i>角色列表</div>
    ...
    <FormDialog v-model:show="dialogVisible" :title="dialogTitle" :rules="rules" :modelValue="form" :loading="submitLoading" width="600px" @submit="handleSubmit">
      ...
      <el-form-item label="菜单权限" prop="menuIds">
        <el-tree ref="menuTreeRef" :data="menuTree" show-checkbox node-key="menuId" :props="{ label: 'menuName', children: 'children' }" :default-checked-keys="form.menuIds" />
      </el-form-item>
