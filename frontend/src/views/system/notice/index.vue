<template>
  <div class="page-container">
    ...
    <PageCard title="公告列表" flex>
      <template #extra>
        <el-button type="primary" @click="handleAdd(form)">新增公告</el-button>
      </template>
      <DataTable
        :data="tableData"
        :loading="loading"
...
const {
  ...
  defaultQuery: { noticeTitle: '', noticeType: '' },
  defaultForm: { noticeTitle: '', noticeType: '1', noticeCont: '', stasFlag: '1' },
  rowKey: 'noticeId',
  title: '公告'
})
</script>
