    ...
    <el-tabs v-model="activeTab" class="dict-tabs">
      ...
      <el-tab-pane label="数据字典" name="data">
        ...
        <div class="table-card">
          ...
          <el-table :data="dataList" v-loading="dataLoading" border style="width: 100%; flex: 1" height="100%" :cell-style="{ textAlign: 'center' }" :header-cell-style="{ textAlign: 'center' }">
            <el-table-column type="index" label="序号" width="60" align="center" />
            <el-table-column prop="dicTypeCode" label="字典类型" min-width="120" />
            <el-table-column prop="dicName" label="字典标签" min-width="120" />
            <el-table-column prop="dicValue" label="字典值" min-width="100" />
      ...
      <el-tab-pane label="字典类型" name="type">
        ...
        <div class="table-card">
          ...
          <el-table :data="typeList" v-loading="typeLoading" border style="width: 100%; flex: 1" height="100%" :cell-style="{ textAlign: 'center' }" :header-cell-style="{ textAlign: 'center' }">
            <el-table-column type="index" label="序号" width="60" align="center" />
            <el-table-column prop="dicTypeCode" label="字典类型" min-width="120" />
            <el-table-column prop="dicTypeName" label="字典名称" min-width="120" />
            <el-table-column prop="stasFlag" label="状态" width="80">
              <template #default="{ row }">
                <el-tag :type="row.stasFlag === '1' ? 'success' : 'danger'">{{ row.stasFlag === '1' ? '正常' : '停用' }}</el-tag>
              </template>
